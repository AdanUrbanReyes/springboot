...
@EnableJpaRepositories(basePackages = "com.ayan.demos.morethanonedatasource.repositories.datasource2"
...
public class DataSource2Configuration {
    ...
    public LocalContainerEntityManagerFactoryBean dataSource2EntityManager() {
        ...
        DataSource ds = dataSource2DataSource();
        em.setDataSource(dataSource2DataSource());
        em.setPackagesToScan("com.ayan.demos.morethanonedatasource.entities.datasource2");
    ...
    public PlatformTransactionManager dataSource2TransactionManager() {
        ...
        transactionManager.setEntityManagerFactory(dataSource2EntityManager().getObject());
